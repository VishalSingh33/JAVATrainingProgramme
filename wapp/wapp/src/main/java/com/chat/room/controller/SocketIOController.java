...
public class SocketIOController {
    ...
    public DataListener<Message> onSendMessage = new DataListener<Message>() {
        ...
        public void onData(SocketIOClient client, Message message, AckRequest acknowledge) throws Exception {
            ...
            log.info(message.getSenderName()+" user send message to user "+message.getSenderName()+" and message is "+message.getMessage());
            socketServer.getBroadcastOperations().sendEvent(message.getSenderName(),client, message);
