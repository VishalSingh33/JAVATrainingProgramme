...
//             log.info(message.getSenderId()+" user send message to user "+message.getSenderId()+" and message is "+message.getMessage());
//             socketServer.getBroadcastOperations().sendEvent(message.getSenderId(),client, message);
