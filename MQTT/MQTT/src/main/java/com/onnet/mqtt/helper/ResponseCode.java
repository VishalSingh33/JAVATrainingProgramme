...
public enum ResponseCode {
	...
	FAIL(500, "FAIL", "Internal Server Error"), 
	NO_TAGS_INFO_PASSED(400, "No tags info passed...", "Bad request"),
	DATA_NOT_FOUND(404, "Data not found", "Failure"), 
	REQUEST_TIMEOUT(408, "Request Timeout", "Time Limit Exceeded"),
	Error_occured(400, "Error occured", "Error Occured"),
