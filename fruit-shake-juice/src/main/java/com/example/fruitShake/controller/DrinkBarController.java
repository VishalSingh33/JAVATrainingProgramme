...
//             @RequestParam(required = false) String dName, @RequestParam(required = false) String status );

 	@PostMapping(value = "/createDrinks")
 	public ResponseEntity<List<DrinkBar>> addDrinks(@RequestBody DrinkBarRequestDto addDrinks);
