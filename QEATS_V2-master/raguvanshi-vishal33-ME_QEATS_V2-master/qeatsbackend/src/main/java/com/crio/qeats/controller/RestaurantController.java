    ...
    GetRestaurantsResponse getRestaurantsResponse;
      ...
      if (getRestaurantsResponse != null && !getRestaurantsResponse.getRestaurants().isEmpty()) {
        ...
        for(int i = 0; i < restaurantList.size(); i++){
          restaurantList.get(i).setName(restaurantList.get(i).getName().replace("é", "e"));
        }
        getRestaurantsResponse.setRestaurants(restaurantList);
      
        // for (Restaurant restaurant : getRestaurantsResponse.getRestaurants()) {
        //     String specialName = restaurant.getName();
        //     specialName = specialName.replaceAll("Café", "cafe");
